# Generated by Powerlevel10k configuration wizard on 2020-09-13 at 17:10 EDT.
...
functions -M my_git_formatter 2>/dev/null
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|pods'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
  # '*prod*'  PROD    # These values are examples that are unlikely
  '*chainlink*'  PROD    # These values are examples that are unlikely
  # '*test*'  TEST    # to match your needs. Customize them as needed.
  '*'       DEFAULT)
